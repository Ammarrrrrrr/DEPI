...
import 'package:pharmacy_system/pages/order/user_single_order.dart';
      ...
      body: StreamBuilder<QuerySnapshot>(
        ...
        builder: (context, snapshot) {
          ...
          for (int i = 0; i < docs.length; i++) {
            if(_store.currentUser.email == docs[i]["email"]){
              orders.add(
                MyOrder(
                  ...
                  child: displayList.isEmpty
                      ...
                      : ListView.separated(
                          ...
                          itemBuilder: (context, index) {
                            ...
                            return InkWell(
                              onTap: (){
                                context.push(UserSingleOrder(date:date, name: name, email: email, address: address, productsIDs: products,finished: tabProvider.selectedIndex == 1,));
                              },
                              child: Container(
